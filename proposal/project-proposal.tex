...
\begin{itemize}
  ...
  \item German Recipes Dataset \url{https://www.kaggle.com/sterby/german-recipes-dataset}
  \item Recipe generation \cite{majumder-etal-2019-generating}
  \item Food.com Dataset with Interactions \cite{https://www.kaggle.com/shuyangli94/food-com-recipes-and-user-interactions} with notebook on sentiment analysis, most/least favourite ingredients
  \item Cultural diffusion: \url{https://www.kaggle.com/alonalevy/cultural-diffusion-by-recipes} on the What's cooking dataset \url{https://www.kaggle.com/c/whats-cooking/overview}
  \item Recipe box dataset \url{https://eightportions.com/datasets/Recipes/#fn:1}
  \item Clustering Recipes \url{https://www.kaggle.com/tboonhau/clustering-recipes}
\end{itemize}
